...
1.装饰器不同
2.类方法有参数，静态方法无参数
3.类方法中只能调用类属性和方法，无法调用实例属性和方法，
静态方法中的方法体无法调用类以及实例中的任何方法和属性
相同：
1.都可以通过类名调用访问
...
print(nowTime)
'''
如上，使用了静态方法（函数），然而方法体中并没使用实例的属性和方法（但可以通过类名调用类属性和类方法）。
